        ...
        <div className="grid gap-6">
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 space-y-6 ">
              <div className="flex bg-prime-bg pl-6 pt-6 rounded-xl gap-6 h-full overflow-hidden">
                ...
                <Image src={box1bg} alt="dashboard" className="mx-auto mt-4  rounded-tl-xl bg-prime-dark" />
              </div>
            </div>
            {/* card 2 */}
          ...
          <div className="grid grid-cols-3 gap-x-6 grid-rows-3">
            <div className="col-span-2 grid grid-cols-4 gap-6 row-span-1">
              {/* card 3 */}
              <div className="bg-prime-dark col-span-3 rounded-xl p-6 flex gap-12 items-center justify-center">
            ...
            {/* card 5 */}
            <div className="row-span-3 bg-prime-bg rounded-xl p-6 flex-col justify-around flex h-full">
            ...
            <div className="flex gap-6 row-span-3 col-span-2 mt-6">
              <div className="bg-prime-dark rounded-xl  flex-col justify-between py-6 px-10 gap-5 grow flex items-center">
                ...
                <Image src={loginimg} alt="-" className="" />
        ...
        <div className="container mx-auto mt-12" id="unique">
          <div className="grid gap-6">
            ...
            <div className="space-y-6 ">
              <div className="flex bg-prime-bg pl-4 pt-4 rounded-xl gap-4 h-full overflow-hidden flex-col">
                <div className="self-center pb-4 space-y-4">
                  <div className="flex items-center gap-3">
                    <Image src={codingIcon} alt="coding icon" className="" />
                    <div className="text-center text-prime-blue text-lg font-black tracking-wide">
            ...
            <div className="bg-prime-dark rounded-xl p-4 flex gap-4 items-center justify-center flex-col">
              <div className="text-center text-prime-blue text-lg font-bold">High-standard
            ...
            {/* card 4 */}
            <div className="bg-prime-dark rounded-xl p-4 flex flex-col items-center justify-around group">
              <Image src={star} alt="coding icon" className="group-hover:animate-spin " />
            ...
            {/* card 5 */}
            <div className="bg-prime-bg rounded-xl p-4 flex-col justify-around flex h-full">
              <div className="text-center text-prime-blue text-xl font-bold">An SEO-automated,
                <span className="text-black text-base font-normal"> optimized & market-ready website</span>
              </div>
              <Image src={dashboard} alt="coding icon" className="mx-auto" />
              <div className="text-center text-black text-sm font-semibold leading-loose">Brings in the advanced technology, process, and automation that the business needs</div>
            </div>

            {/* card 6 */}
            <div className="bg-prime-dark rounded-xl w-full flex-col justify-between p-4 flex items-center">
              <div className="w-full text-center text-white text-lg font-bold">Proven strategy with
                <span className="text-prime-blue text-lg font-bold">“N” number of businesses</span>
              </div>
              <Image src={loginimg} alt="-" />
              <div className="w-full text-center text-prime-blue text-xl font-bold">Highest ROI
                <span className="text-white text-xl font-bold"> from the marketing investments</span>
              </div>
            </div>

            {/* card 7 */}
            <div className="bg-prime-bg rounded-xl py-4 px-4 space-y-4">
              <div className="text-center text-prime-blue text-lg font-black">4X times smaller
                <span className="text-black text-sm font-normal"> Teams & brings down the operations costs significantly</span>
              </div>
              <div className="text-center text-prime-blue text-lg font-black">6X times faster
                <span className="text-black text-sm font-normal"> Than other companies have seen their growth</span>
              </div>
              <div className="text-center text-prime-blue text-lg font-black">10X times lesser
